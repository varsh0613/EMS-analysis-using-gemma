#!/usr/bin/env python3
"""Analyze high-risk EMS cases by location"""
...
print(delays_df.to_string(index=False))

# INCIDENT TYPES IN HIGH RISK BY CITY
print("\n\n" + "="*70)
print("MOST COMMON INCIDENT TYPES IN HIGH RISK CASES - TOP 5 CITIES")
print("="*70)
...
print(f"  - high_risk_by_city.csv")
print(f"  - high_risk_by_county.csv")
print(f"  - high_risk_delays_by_city.csv")
print("="*70)
